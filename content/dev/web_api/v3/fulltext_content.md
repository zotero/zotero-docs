...
These methods are also available in the [local API](dev/web_api/v3/local_api#full-text_content), where the versions returned are local versions rather than server versions.
