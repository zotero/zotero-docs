...
## Changes in 10.0 (Not yet released)
...
- Reader improvements
    ...
    - EPUB/snapshot: Position text-selection popup at focus end of selection
...
- Drop versioned database backups and force a regular backup before all database upgrades
